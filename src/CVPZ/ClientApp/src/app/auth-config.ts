...
export const b2cPolicies = {
  ...
  authorities: {
    signUpSignIn: {
      authority:
        'https://cremaclients.b2clogin.com/cremaclients.onmicrosoft.com/B2C_1_CVPZ_SUpSIn',
    },
    editProfile: {
      authority:
        'https://cremaclients.b2clogin.com/cremaclients.onmicrosoft.com/B2C_1_CVPZ_ProfileEdit',
    },
    forgotPassword: {
      authority:
        'https://cremaclients.b2clogin.com/cremaclients.onmicrosoft.com/B2C_1_CVPZ_ResetPassword',
    },
  },
